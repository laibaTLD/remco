...
// ----------------------------------------------------------------------
// UPDATED INTERFACE TO HANDLE IMAGES FROM DATABASE
// ----------------------------------------------------------------------
        ...
        <div className="absolute inset-0 z-0">
          {displayImages.map((image, index) => (
            <Image
              key={index}
              src={image}
              alt={heroImages.length > index ? heroImages[index].altText || "Construction background image" : "Construction background image"}
              fill
              priority={index === 0}
