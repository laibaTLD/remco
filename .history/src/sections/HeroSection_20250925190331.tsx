...
const { ref: ctaRef, isVisible: ctaVisible } = useScrollAnimation<HTMLDivElement>({ threshold: 0.3 });const titleAnimation = useScrollAnimation<HTMLHeadingElement>({ threshold: 0.3 });
