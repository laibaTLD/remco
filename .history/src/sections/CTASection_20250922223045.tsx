...
const CTASection: React.FC<CTASectionProps> = ({ data, theme, images }) => {
  ...
  // Handle scroll effects for fixed background
  useEffect(() => {
    setIsLoaded(true);
  ...
  return (
    <>
      ...
      >
        {/* Fixed Background Image with mobile optimization */}
        <div 
        ...
        >
          <NextImage
            ...
            sizes="100vw"
            priority
            style={{ position: 'fixed', willChange: 'transform', transform: 'translateZ(0)' }}
          />
          
          {/* Overlay with gradient - fixed position with mobile optimization */}
          <div 
          ...
          <div className="shimmer-overlay" style={{ position: 'fixed', willChange: 'transform', transform: 'translateZ(0)' }}></div>
        </div>
