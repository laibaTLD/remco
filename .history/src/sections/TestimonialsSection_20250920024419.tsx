        ...
        <div className="flex flex-wrap justify-center">
          {testimonials.map((testimonial, index) => (
            <div
              ...
              className={`testimonial-card bg-white/95 backdrop-blur-md p-8 rounded-xl shadow-lg scale-in-animation w-full md:w-[calc(50%-1rem)] lg:w-[calc(50%-2rem)] mx-4 my-6 ${
