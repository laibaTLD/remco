...
export default function FAQSection({
  ...
  return (
    ...
    >
      {/* Decorative elements */}
      <div 
        className="absolute top-20 right-1/4 w-96 h-96 opacity-5"
        style={{
      ...
      <div 
        className="absolute bottom-32 left-1/3 w-64 h-64 opacity-4"
        style={{
          background: `radial-gradient(ellipse, ${secondaryColor}25, transparent 60%)`,
          borderRadius: '60% 40% 30% 70% / 60% 30% 70% 40%',
