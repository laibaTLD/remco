      ...
      <section className="relative overflow-hidden min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {[...Array(20)].map((_, i) => {
            ...
            const topPositions = [8.15, 37.13, 40.11, 21.18, 84.52, 16.16, 52.34, 73.91, 29.45, 61.78, 
                                 45.23, 12.67, 33.89, 78.12, 5.43, 67.21, 39.56, 81.34, 24.67, 59.32];
            const leftPositions = [23.04, 7.53, 31.56, 48.92, 14.04, 13.57, 36.78, 42.19, 27.65, 51.43, 
                                  19.87, 63.24, 8.91, 72.56, 44.32, 58.76, 11.23, 83.45, 39.67, 76.21];
            const delays = [2.22, 0.98, 2.05, 1.49, 1.78, 0.56, 2.67, 1.34, 0.78, 2.89, 
                           1.12, 2.45, 0.34, 1.67, 2.78, 0.45, 1.89, 2.34, 0.67, 1.23];
