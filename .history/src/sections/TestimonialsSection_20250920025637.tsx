    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative">
          ...
          <button 
            onClick={prevSlide}
            className="absolute top-1/2 left-4 md:left-8 -translate-y-1/2 w-12 h-12 rounded-full bg-white/80 backdrop-filter backdrop-blur-sm flex items-center justify-center shadow-lg z-10 transition-all hover:bg-white"
          ...
          <button 
            onClick={nextSlide}
            className="absolute top-1/2 right-4 md:right-8 -translate-y-1/2 w-12 h-12 rounded-full bg-white/80 backdrop-filter backdrop-blur-sm flex items-center justify-center shadow-lg z-10 transition-all hover:bg-white"
