...
export default function Navbar({
  ...
  return (
    <>
      ...
      <nav className={`luxury-navbar transition-all duration-300 ${
        ...
        <div className="luxury-navbar-container">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {navItems.slice(0, 2).map((item, index) => (
              ...
              >
                <span className="luxury-nav-text">{item.label}</span>
                <div className="luxury-nav-shimmer"></div>
              </Link>
            ))}
          </div>
          ...
          <div className="luxury-logo-container">
            <Link href="/" className="luxury-logo-link">
              {logoImage ? (
                <div className="flex items-center gap-3">
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="luxury-logo-image"
                    priority
                  />
                  <h1 className="luxury-logo-text" style={{ color: '#333' }}>
                    {businessName}
                  </h1>
                </div>
              ) : (
                <h1 className="luxury-logo-text-only" style={{ color: '#333' }}>
                  {businessName}
                </h1>
              )}
            </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <Link
              ...
              className="luxury-cta-nav-button"
            >
              <span className="luxury-cta-text">Call Us</span>
              <div className="luxury-cta-shimmer"></div>
